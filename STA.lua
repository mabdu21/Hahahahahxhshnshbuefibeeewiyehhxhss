...
local assetName = "survive the apocalypse"
...
local Window = Library:CreateWindow({
    Title = "DYHUB | STA",
    Footer = "" .. assetName .. " | by dyumra | STA | Version 4.5.3",
	NotifySide = "Right",
...
local GB = {
    Information = {
        Left = {
            ...
            Game = Tabs.Information:AddLeftGroupbox("Lobby", "gamepad"),
        },
        Right = {
...
GB.Information.Left.Game:AddButton("Claim Daily Emeralds", function()
    
    local daily = workspace:FindFirstChild("Daily Emeralds")
    
    if daily and daily:FindFirstChild("PromptTriggered") then
        
        Library:Notify("Daily Reward: Claiming Emeralds...", 5)
        
        daily.PromptTriggered:InvokeServer()
        
        task.wait(2)
        
        Library:Notify("Daily Reward: Emeralds successfully claimed!", 5)
        
    else
        
        Library:Notify("Daily Reward: Already claimed. Please wait for the next reset (24h).", 6)
...
Library:OnUnload(function()
    ...
    Library:Notify({ Title = "DYHUB", Description = "Unloaded. Bye!", Time = 3 })
    print("[DYHUB] Hi, i am print")
end)
...
SaveManager:SetFolder("DYHUB/survive-the-apocalypse")
...
-- INIT NOTIFICATION
-- ============================================
Library:Notify({ Title = "DYHUB", Description = "Loaded! Module Assets\nRight Shift = toggle menu.", Time = 5 })

local espCounts = { Gun="Red", Melee="Orange", Medical="Green", Armor="Blue", Food="Lime", Resource="Silver" }
print("[DYHUB] Log Qn | " .. #itemNames .. " items tracked | Right Shift = menu")
